...
//             <span className="font-semibold text-pink-600">DigiCash</span> —
...
//             <Link
//               to="/features"
//               className="bg-white text-pink-600 px-6 py-3 rounded-full shadow-lg border hover:bg-gray-100 transition"
//             >
//               Learn More
//             </Link>
//           </div>
...
//             src={Home_Banner}
//             alt="DigiCash Banner"
//             className="w-full h-auto bg-pink-50 rounded-lg"
//           />
//         </div>
//       </div>
//     </section>
